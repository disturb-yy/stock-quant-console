...
const demoStatus = {
  ...
  as_of: '2024-06-28',
  counts: { instruments: 3, daily_bars: 6, daily_basics: 6, financial_metrics: 6, financial_reports: 27, valuation_snapshots: 6, index_snapshots: 4 },
...
describe('DashboardPage demo status states', () => {
  ...
  it('keeps an empty backend response explicit and retries through the same client', async () => {
    const user = userEvent.setup()
    fetchDemoStatusMock
      .mockResolvedValueOnce({ ...demoStatus, counts: { instruments: 0, daily_bars: 0, daily_basics: 0, financial_metrics: 0, financial_reports: 0, valuation_snapshots: 0, index_snapshots: 0 }, sample_stocks: [] })
